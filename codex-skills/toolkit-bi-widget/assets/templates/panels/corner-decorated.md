# 四角装饰面板模板 (CornerDecoratedPanel)

完整参考：`references/component-templates.md` CornerDecoratedPanel 章节
...
| cornerStyle | String | 'line' | 角样式：line/square/lshape |
...
完整四角装饰面板代码请参考 `references/component-templates.md` 中 CornerDecoratedPanel 章节。
