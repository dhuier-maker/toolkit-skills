...
| [H — ReAct + Stop Conditions](#template-h--react--stop-conditions) | Codex, Devin — autonomous agents |
...
**Important:** Only use CoT for standard reasoning models (Codex, GPT-4o, Gemini). Do NOT add CoT instructions to o1, o3, or Codex extended thinking — they reason internally and CoT instructions degrade their output.
...
- Use XML tags to wrap examples — Codex parses XML reliably.
...
*Use for Codex, Devin, AutoGPT, and any AI that takes autonomous actions. Runaway loops and scope explosion are the biggest credit killers in agentic workflows — stop conditions are not optional.*
