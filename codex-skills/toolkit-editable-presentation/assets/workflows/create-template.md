...
```bash
python skills/toolkit-editable-presentation/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p "skills/toolkit-editable-presentation/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `skills/toolkit-editable-presentation/templates/layouts/`; project templates go to `projects/<project>/templates/`
>
...
```bash
ls -la "skills/toolkit-editable-presentation/templates/layouts/<template_id>"
```

Run SVG validation on the template directory:

```bash
python skills/toolkit-editable-presentation/scripts/svg_quality_checker.py "skills/toolkit-editable-presentation/templates/layouts/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
python skills/toolkit-editable-presentation/scripts/register_template.py <template_id>
```

Outputs:

- updates `skills/toolkit-editable-presentation/templates/layouts/layouts_index.json` — the flat `template_id → { summary, keywords }` map
- refreshes the auto-managed Quick Index inside `skills/toolkit-editable-presentation/templates/layouts/README.md` (the surrounding category sections stay hand-edited)
...
>
> ```bash
> python skills/toolkit-editable-presentation/scripts/register_template.py --rebuild-all
> ```
