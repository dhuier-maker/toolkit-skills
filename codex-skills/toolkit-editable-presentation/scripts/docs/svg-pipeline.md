...
```bash
python scripts/svg_to_pptx.py <project_path>
python scripts/svg_to_pptx.py <project_path> --only native
python scripts/svg_to_pptx.py <project_path> --only legacy
python scripts/svg_to_pptx.py <template_import_output> --only native -s svg-flat
