...
Usage:
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py <project_path> --voice zh-CN-XiaoxiaoNeural
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py <project_path> --provider elevenlabs --voice-id <voice_id>
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py <project_path> --provider minimax --voice-id <voice_id>
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py <project_path> --provider qwen --voice-id <voice>
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py <project_path> --provider cosyvoice --voice-id <voice>
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py --list-common-voices
    python skills/toolkit-editable-presentation/scripts/notes_to_audio.py --list-voices --locale zh-CN
...
def main() -> int:
    ...
    if args.provider == "edge" and not args.voice:
        parser.error(
            ...
            "(e.g. --locale zh-CN), or follow skills/toolkit-editable-presentation/workflows/generate-audio.md "
