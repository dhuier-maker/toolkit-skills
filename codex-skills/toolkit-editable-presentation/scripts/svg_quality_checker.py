...
def print_usage() -> None:
    ...
    print("  python scripts/svg_quality_checker.py <template_dir> --template-mode")
    ...
    print("  python scripts/svg_quality_checker.py templates/layouts/anthropic --template-mode")
    print("\nOptions:")
