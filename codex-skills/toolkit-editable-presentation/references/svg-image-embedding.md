...
```bash
python scripts/svg_finalize/embed_images.py <svg_file>                         # Single file
python scripts/svg_finalize/embed_images.py <project_path>/svg_output/*.svg    # Batch
python scripts/svg_finalize/embed_images.py --dry-run <project_path>/svg_output/*.svg  # Preview
```
