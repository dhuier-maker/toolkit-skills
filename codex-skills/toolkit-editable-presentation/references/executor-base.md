...
```bash
ls skills/toolkit-editable-presentation/templates/icons/chunk-filled/ | grep home
ls skills/toolkit-editable-presentation/templates/icons/tabler-filled/ | grep home
ls skills/toolkit-editable-presentation/templates/icons/tabler-outline/ | grep chart
ls skills/toolkit-editable-presentation/templates/icons/phosphor-duotone/ | grep house
ls skills/toolkit-editable-presentation/templates/icons/simple-icons/ | grep github
```
