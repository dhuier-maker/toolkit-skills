...
Combines activity toolkit-diagram-generator control flow with sequence toolkit-diagram-generator interaction fragments.
...
group Authentication
  ...
  note right
    ...
    sequence toolkit-diagram-generator
  end note
end group
