...
<div style="max-width: 960px; box-sizing: border-box; position: relative;">
  ...
  <div class="card">
    ...
    <p class="card-subtitle">The central stack answers how content flows top to bottom. The rails carry the threads that cut across every layer and usually get lost in a pure layered toolkit-diagram-generator.</p>
