...
5. Run the matching calculator command:
   ...
   python skills/toolkit-editable-presentation/scripts/svg_position_calculator.py calc bar \
   ...
   python skills/toolkit-editable-presentation/scripts/svg_position_calculator.py calc line \
     --data "x1:y1,x2:y2,..." --area "x_min,y_min,x_max,y_max" --y-range "0,max"

   # pie_chart
   python skills/toolkit-editable-presentation/scripts/svg_position_calculator.py calc pie \
   ...
   python skills/toolkit-editable-presentation/scripts/svg_position_calculator.py calc radar \
...
```bash
python skills/toolkit-editable-presentation/scripts/svg_quality_checker.py <project_path>
```
...
```bash
python skills/toolkit-editable-presentation/scripts/total_md_split.py <project_path>
python skills/toolkit-editable-presentation/scripts/finalize_svg.py <project_path>
