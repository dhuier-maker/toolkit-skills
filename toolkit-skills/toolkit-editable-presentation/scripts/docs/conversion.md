...
python scripts/source_to_md/pdf_to_md.py ./pdfs -o ./markdown
```
...
python scripts/source_to_md/ppt_to_md.py ./decks -o ./markdown
...
```bash
python scripts/rotate_images.py auto projects/xxx_files
python scripts/rotate_images.py gen projects/xxx_files
