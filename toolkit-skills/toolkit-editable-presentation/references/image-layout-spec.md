...
```bash
python scripts/analyze_images.py <project_path>/images                    # Default: PPT 16:9
python scripts/analyze_images.py <project_path>/images --canvas ppt43     # PPT 4:3
python scripts/analyze_images.py <project_path>/images --canvas xiaohongshu  # Xiaohongshu
```
