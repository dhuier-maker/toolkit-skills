...
**按需加载框架文件**：根据匹配到的框架名称，仅读取 `references/frameworks/` 目录下对应的单个框架文件，不要一次性全部加载。

常用框架快速索引：

| 场景 | 推荐框架 | 文件 |
|------|---------|------|
| 通用任务结构化 | APE | `20_APE_Framework.md` |
| 复杂推理 | Chain of Thought | `48_Chain_of_Thought_Framework.md` |
| 创意发散 | SCAMPER | `07_SCAMPER_Framework.md` |
| 决策分析 | Pros and Cons | `17_Pros_and_Cons_Framework.md` |
| 目标设定 | SMART | `39_SMART_Framework.md` |
| 问题分析 | 5W1H | `28_Five_Ws_and_One_H_Framework.md` |
| 角色扮演 | CARE | `22_CARE_Framework.md` |
| 简化解释 | ELI5 | `23_ELI5_Framework.md` |

读取 [references/Frameworks_Summary.md](references/Frameworks_Summary.md) 获取完整框架列表，然后：
